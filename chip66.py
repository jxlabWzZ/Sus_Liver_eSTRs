...
def ExtractData(gene, chrom, start, tissue, newdata=True):
    ...
    vcf = "/home/wuzhongzi/hip_str/03DNA_output/project525/all556/a200_fa6.vcf.gz"
...
plt.suptitle("");
plt.show()
plt.savefig("/home/wuzhongzi/hip_str/03DNA_output/project525/all556/eSTR_1MB_F6/01.fdr/08.plot/chipseq66/f6_%s.pdf"%gene)
...
#plt.show()
plt.savefig("/home/wuzhongzi/hip_str/03DNA_output/project525/all556/eSTR_1MB_F6/01.fdr/08.plot/chipseq66/f6_%s.png"%gene)
