...
def PrintLine(str_locus, snp_locus, ld, rs):
    for ldval in ld:
        ...
        ld_r2 = ld_r**2
        kldiv = ldval[4]
        sys.stdout.write("\t".join(map(str, [str_locus, snp_locus, allele, freq, maf, kldiv, ld_r2, ld_pval],rs))+"\n")
        sys.stdout.flush()
        ...
        with open(fname, "r") as f:
            for line in f:
                ...
                for i in range(len(snp_loci)):
                    ...
                    PrintLine(str_locus, snpid, ld,rs)
