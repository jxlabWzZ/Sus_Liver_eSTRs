...
STRGTFILE = ""
OUTFILE = ""
TMPDIR = "/home/wuzhongzi/biosoft/gtex-estrs/gtex-estrs-paper/str-regression/"
CHECKCHROM = False
PERMUTE_EXPR = False
DEBUG = False
MINSAMPLES = 0
...
if __name__ == "__main__":
    ...
    for i in range(expr_annot.shape[0]):
        ...
        for j in range(len(str_ids)):            
            ...
            res_ols, beta, beta_se, p = LinearRegression(locus_str, locus_y["expr"].values, norm=NORM, minsamples=MINSAMPLES)
